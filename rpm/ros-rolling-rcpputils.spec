...
%package runtime
Summary:        Runtime-only files for rcpputils package
...
%description runtime
Runtime-only files for rcpputils package
...
for f in \
    ...
    /opt/ros/rolling/share/rcpputils/cmake/ \
    /opt/ros/rolling/share/rcpputils/package.dsv \
    /opt/ros/rolling/share/rcpputils/package.xml \
; do
...
%exclude /opt/ros/rolling/share/rcpputils/cmake
%exclude /opt/ros/rolling/share/rcpputils/package.dsv
%exclude /opt/ros/rolling/share/rcpputils/package.xml

%changelog
* Tue Mar 21 2023 Brandon Ong <brandon@openrobotics.org> - 2.6.1-2
